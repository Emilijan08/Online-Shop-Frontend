              ...
              <div>
                ...
                <ul role="list" class="mt-6 space-y-6">
                  <li v-for="item in footerNavigation.products" :key="item.name" class="text-sm">
                    <a to="#" class="text-gray-500 hover:text-gray-600">{{ item.name }}</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul role="list" class="mt-6 space-y-6">
                  <li v-for="item in footerNavigation.company" :key="item.name" class="text-sm">
                    <a href="/aboutus" class="text-gray-500 hover:text-gray-600">{{ item.name }}</a>
                  </li>
                </ul>
              </div>
            </div>
            <div>
              ...
              <ul role="list" class="mt-6 space-y-6">
                <li
                  ...
                  class="text-sm"
                >
                  <router-link to="/faq" class="text-gray-500 hover:text-gray-600">{{
                    item.name
                  }}</router-link>
                </li>
              </ul>
