          ...
          <TabPanels as="template">
            <TabPanel class="-mb-10">
              ...
              <div
                ...
                :key="comment.id"
                class="flex space-x-4 text-sm text-gray-500 w-full"
              >
                <div class="flex-none py-10">
                  <UserCircleIcon class="h-10 w-10 rounded-full bg-gray-100" aria-hidden="true" />
                </div>
                <div :class="[index === 0 ? '' : 'border-t', 'border-gray-200', 'py-10', 'w-full']">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500" v-html="comment.text" />
                </div>
              </div>
            </TabPanel>
          </TabPanels>
