                    ...
                    <tr v-for="(product, index) in store.productsOnCart" :key="index">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center justify-between w-24">
                          <button class="text-gray-500 hover:text-gray-700" @click="decrease(product._id)"
                      ...
                      product.quantity
                          ...
                          <button class="text-gray-500 hover:text-gray-700" @click="increase(product._id)"
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">
                          ${{
                      Math.round(product.quantity * product.price * 1e12) /
                      1e12
                    }}
                        </div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <button class="text-gray-500 hover:text-gray-700" @click="removeItem(product._id)"
