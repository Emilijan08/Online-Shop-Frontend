    ...
    <div class="bg-gray-200 min-h-screen flex items-center justify-center">
      <div class="bg-gray-700 p-8 rounded-lg shadow-lg max-w-md">
        ...
        <p class="mt-4 text-white">
          ...
          <RouterLink to="/register" class="underline hover:text-gray-400">Register here</RouterLink>
        </p>
      </div>
    </div>
        ...
        <div :class="store.error ? 'scale-100' : ''"
          ...
          <div class="mt-6">
            <button
              ...
              <RouterLink @click="
                ; (store.error = !store.error), (username = ''), (password = '')
          " to="/login">Try again</RouterLink>
            </button>
          </div>
        </div>
      </div>
